...
mkdir -p "$HOME/.config/opencode/superfast"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/superfast/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/superfast/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/superfast/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/superfast.js" "$HOME/.config/opencode/superfast/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/superfast/.opencode/plugins/superfast.js" \
       "$HOME/.config/opencode/plugins/superfast.js"
...
echo "Plugin installed to: $HOME/.config/opencode/superfast/.opencode/plugins/superfast.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/superfast.js"
