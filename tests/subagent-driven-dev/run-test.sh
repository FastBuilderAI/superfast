...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/superfast
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/superfast-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using superfast:subagent-driven-development. The plan is at: $PLAN_PATH"
