...
## Is this a Superfast issue or a platform issue?
<!-- Superfast is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Superfast installed.

     If the problem persists without Superfast, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Superfast installed
