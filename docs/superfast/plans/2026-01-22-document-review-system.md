...
> **For agentic workers:** REQUIRED: Use superfast:subagent-driven-development (if subagents available) or superfast:executing-plans to implement this plan.
...
**Spec:** docs/superfast/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/superfast/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use superfast:subagent-driven-development (if subagents available) or superfast:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
